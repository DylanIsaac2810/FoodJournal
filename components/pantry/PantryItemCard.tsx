...
export function PantryItemCard({ item }: { item: any }) {
  // Calculamos el estado en tiempo real (por si pasaron días desde que se guardó)
  ...
  return (
    <div className="p-5 rounded-3xl bg-white border border-[#335C67]/10 hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
